...
from spy.error import NumberOfElementError
...
class TestFitsArray(unittest.TestCase):
    ...
    def test_zero_correction(self):
        ...
        self.assertIn("SPY_ZERO", new_fits_array.header().columns)
    ...
    def test_dark_correction(self):
        ...
        self.assertIn("SPY_DARK", new_fits_array.header().columns)
    ...
    def test_flat_correction(self):
        ...
        self.assertIn("SPY_FLAT", new_fits_array.header().columns)
